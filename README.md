...
- 📤 **Compartir y Guardar**:
  ...
  - Compartir directo por WhatsApp, Email, Drive o almacenamiento nativo.
...
4. Escanea el código QR desde la app **Expo Go** en tu dispositivo Android.
